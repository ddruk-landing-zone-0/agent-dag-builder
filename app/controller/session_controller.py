...
def add_node():
    ...
    try:
        ...
        new_node = graph_session_manager.add_node_to_session(session_id, node_name, system_instructions, user_prompt, python_code, output_schema)
        return jsonify({"new_node": new_node.to_dict()}), 200
    except Exception as e:
        return jsonify({"error": str(e)}), 500
...
def update_node():
    ...
    try:
        ...
        updated_node = graph_session_manager.update_node_in_session(session_id, node_name, system_instructions, user_prompt, python_code, output_schema)
